...
const ED: Record<string, { n: string; p: number }[]> = {
  ...
  '모니터/무선': [
    { n: '홀리랜드 솔리드컴 C1 PRO 인터컴 6S', p: 70000 }, { n: '홀리랜드 솔리드컴 C1 PRO 인터컴 4S', p: 50000 },
    { n: '홀리랜드 솔리드컴 SE 인터컴 8S', p: 70000 }, { n: '홀리랜드 솔리드컴 SE 인터컴 5S', p: 50000 },
    { n: '홀리랜드 솔리드컴 SE 인터컴 4S', p: 40000 },
  ...
  '오디오': [
    ...
    { n: 'Synco Xtalk XMax 인터컴 9구', p: 70000 }, { n: '줌 F6', p: 20000 },
    { n: '모토로라 무전기 4세트', p: 20000 }, { n: '젠하이져 MKH-416P', p: 15000 },
    { n: 'DJI 무선마이크', p: 10000 },
  ],
  '기타': [
