      ...
      <main className="pt-20">
        <div className="max-w-[1920px] mx-auto px-8 md:px-20 py-24">
          <div className="mb-16">
            ...
            <p className="text-sm text-on-surface-variant mt-4">{results.length}개 장비</p>
          </div>
          ...
          {results.length > 0 ? (
            ...
            <div className="text-center py-20">
              <span className="material-symbols-outlined mb-4 block" style={{ fontSize: "48px", color: "#D3C5AE" }}>search_off</span>
              <p className="text-lg font-bold mb-2">검색 결과가 없습니다</p>
              <p className="text-sm text-on-surface-variant">다른 키워드로 검색해보세요</p>
            </div>
          )}
        </div>
      </main>
